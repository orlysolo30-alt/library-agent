...
## 📖 הספר בחיי הסופר/ת — הקשר העמוק
- **מתי בחייו/ה נכתב**: גיל, שלב בחיים, מה קדם לו — הספר הראשון? אחרי משבר?
- **הטריגר לכתיבה**: מה קרה בחיים האישיים שגרם לכתיבת הספר הזה דווקא?
- **מה נלקח מהביוגרפיה**: דמויות, אירועים, מקומות אמיתיים שחדרו לספר
- **הרקע ההיסטורי והחברתי**: מה קרה בעולם בזמן הכתיבה — ואיך זה נוכח?
