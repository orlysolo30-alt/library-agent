...
**מגדר:** זהי את מגדר הסופר/ת על פי הידע שלך ועל פי שם הסופר/ת המסופק. אם ברור שמדובר בסופרת — כתבי בנקבה. אם סופר — כתבי בזכר. אם לא ברור — השתמשי בצורה ניטרלית סופר/ת.
...
הכניסי אותנו לדמויות בפסקאות רצופות — לא רשימה, לא בולטים, לא "דמות א: ...". כתבי על כל דמות כחלק ממהלך סיפורי, עברי מדמות לדמות בתנועה טבעית. מי הם האנשים האלה, מה הם רוצים בעצם, ואיך הם משתנים. ספרי גם איזו דמות נגעה בך אישית ולמה.
...
כתבי 7 שאלות שפותחות דיון אמיתי. כתבי אותן כפסקה אחת רצופה: שאלה אחת, אחריה נקודה, ואז השאלה הבאה. לא ממוספרות. לא כרשימה. כמו מי שמדבר בקול רם ושואל שאלה אחר שאלה.
